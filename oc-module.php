...
namespace shenanigans {
    function define($k, $v){ 
        global $constants_holder;
        $constants_holder[$k] = $v;
    }
}
...
EOT;
    ...
    if(is_file('config.php')) {
        $constants_holder = array();
        eval('namespace shenanigans {?>'.file_get_contents('config.php').'<?php }');
        $site = $constants_holder;
    }

    if(is_file('admin/config.php')) {
        $constants_holder = array();
        eval('namespace shenanigans {?>'.file_get_contents('admin/config.php').'<?php }');
        $admin = $constants_holder;
    }

    unset($constants_holder);
